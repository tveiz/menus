...
-- Referencie seu menu principal aqui:
local mainUI = script.Parent -- Altere se necessário

-- Botão de Minimizar (criado ao lado do botão de fechar "X")
local minimizeButton = Instance.new("TextButton")
minimizeButton.Size = UDim2.new(0, 25, 0, 25)
minimizeButton.Position = UDim2.new(1, -55, 0, 5) -- ao lado do "X"
...
-- Retângulo para Mobile
local mobileToggleButton = Instance.new("TextButton")
mobileToggleButton.Size = UDim2.new(0, 120, 0, 35)
mobileToggleButton.Position = UDim2.new(0.5, -60, 0, 10)
mobileToggleButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
mobileToggleButton.Text = "Abrir Menu"
...
mobileToggleButton.Parent = mainUI

-- Arredondamento do botão mobile
local corner = Instance.new("UICorner")
corner.CornerRadius = UDim.new(0, 15)
corner.Parent = mobileToggleButton

-- Função para esconder/exibir menu
local function toggleMenu()
	mainUI.Visible = not mainUI.Visible

	if isMobile then
		mobileToggleButton.Visible = not mainUI.Visible
	end
end
...
-- Conectar botão mobile
mobileToggleButton.MouseButton1Click:Connect(toggleMenu)

-- Conectar tecla K no PC
